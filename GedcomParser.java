    ...
    */
    ...
    public void parse(InputSource source) throws SAXException, IOException {
        ...
        if (source.getCharacterStream()!=null) {
			...
			AnselInputStreamReader theAnselReader = new AnselInputStreamReader( source.getByteStream() );
			BufferedReader theBufferedReader = new BufferedReader( theAnselReader );
			parse( theBufferedReader );
            ...
            if (line.length() > 0) {
                ...
                if ( line.startsWith("@")) {
					...
					if (token2.length()==1 || !token2.endsWith("@")) {
						System.out.println( "This line sucks: " + currentLine );
